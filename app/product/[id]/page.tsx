...
async function page({ params }: { params: any }) {
  ...
  return (
    <div className="p-4 lg:px-20 xl:px-40 flex flex-col md:flex-row gap-4 justify-around  h-[calc(100vh-9rem)] md:h-[calc(100vh-14rem)] md:items-center">
      <div className="h-1/2 md:h-[70%] relative pt-2 w-full">
        {singleProduct.img && (
          <Image
      ...
      <div className="h-1/2 flex flex-col text-red-500 gap-5 md:gap-6 lg:gap-7 items-start justify-center md:h-[70%] w-1/2 ">
